...
public class AddressBook {
    ...
    private static final String MESSAGE_COUNT_PERSONS = "The total number of contacts in your address book is %1$d!";
    ...
    private static final String COMMAND_COUNT_DESC = "Displays the total number of persons in the address book.";
    ...
    private static void showWelcomeMessage() { showToUser(DIVIDER, DIVIDER, VERSION, MESSAGE_WELCOME, DIVIDER); }
    ...
    */
    ...
    /** Return string for showing 'count' command usage instruction */
